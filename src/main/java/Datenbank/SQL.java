...
public class SQL {
    ...
    // Prüfung, ob Wert bereits in Datenbank vorhanden (Übergabe von der Kombination Integer, Integer, String)
    public static boolean checkElementAlreadyInDatenbankIntegerIntegerString(Integer eingabe1, Integer eingabe2, String eingabe3, String field1, String field2, String field3, String table){
        boolean inDatenbank = false;
        ...
        try(
            ...
            pstmtSelect.setInt(1, eingabe1);
            pstmtSelect.setInt(2, eingabe2);
            pstmtSelect.setString(3, eingabe3);
            ResultSet resultSelect = pstmtSelect.executeQuery();
            int result = 1;
            while (resultSelect.next()) {
                result = Integer.parseInt(resultSelect.getString(1));
    ...
    // Prüfung, ob Wert bereits in Datenbank vorhanden (Übergabe von der Kombination Integer, Integer)
    public static boolean checkElementAlreadyInDatenbankIntegerInteger(Integer eingabe1, Integer eingabe2, String field1, String field2, String table){
        boolean inDatenbank = false;
